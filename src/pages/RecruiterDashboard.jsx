...
import data from "../assets/fakeData/dataCandidates";
...
function RecruiterDashboard(props) {
  ...
  return (
    <>
      ...
      <Breadcrumb title="Recruiter" className="breadcrumb-section" />
      <Form2 />
                      ...
                      <div key={idx.id} className="employer-block style-3 cl3">
                        <div className="inner-box">
                          ...
                          <div className="group-btn">
                            ...
                            <button className="btn-employer">View Full Profile</button>
